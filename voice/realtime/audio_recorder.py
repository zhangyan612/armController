...
INIT_MODEL_TRANSCRIPTION_REALTIME = "base.en"
            ...
            while self.is_running:
                ...
                try:
                    ...
                    while (self.audio_queue.qsize() >
                        ...
                        if not queue_overflow_logged:
                            logging.debug("Audio queue size exceeds latency "
                                            "limit. Current size: "
                ...
                if not self.is_recording:
                    ...
                    if self.wake_words and wake_word_activation_delay_passed:
                        ...
                        if wakeword_index >= 0:
                            logging.debug('wake work detected')
                    ...
                    if ((not self.wake_words
                        ...
                        if self._is_voice_active():
                            ...
                            # logging.debug("no voice activity")
                            data_copy = data[:]
