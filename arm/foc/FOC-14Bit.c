...
{    
    ...
    switch(pattern)
    {
        case 2:
            ...
            // 采样前再主动请求一次编码器，确保mid_angle采样时MGT_angle已更新
            Send_Request();
            HAL_Delay(2);
            mid_angle= getAngle();
            ...
            // 采样前再主动请求一次编码器，确保end_angle采样时MGT_angle已更新
            Send_Request();
            HAL_Delay(2);
            end_angle= getAngle();
