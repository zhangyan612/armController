...
if __name__ == '__main__':
    ...
    obama_image = face_recognition.load_image_file("D:\Robot/armController/face_1708150594.png")
    obama_face_encoding = face_recognition.face_encodings(obama_image)[0]

    # Load a second sample picture and learn how to recognize it.
    biden_image = face_recognition.load_image_file("D:\Robot/armController/face_1708150604.png")
