...
电机通信为CAN 2.0通信接⼝，波特率1Mbps，采⽤扩展帧格式，如下所⽰：
29位ID   
Bit28~bit24   通信类型
bit23~8   数据区2 
bit7~0  ⽬标地址 

8Byte数据区  Byte0 - Byte7  数据区1
...
05 70 00 00 01 00 00 00 数据帧

0d 0a 帧尾

其中扩展帧canid转译为真实canid需要经过以下转换：
90 07 e8 0c转换成⼆进制为1001 0000 0000 0111 1110 1000 0000 1100，去掉右边的100，则为1 0010 0000 0000 1111 1101 0000
0001，将其转换为16进制，为 12 00 FD 01，对照通信协议说明，含义如下：
