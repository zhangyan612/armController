...
def send_blocked_message(msg, port=PORT, baud=BAUD, repeats=1, timeout=0.5, rts_settle=0.05, inter_byte_delay=0.01, post_tx_wait=0.1):
...
def main():
    ...
    send_single_byte_test([0x43, 0x3B], repeats=3, rts_settle=0.08, post_tx_wait=0.08)
    ...
    send_blocked_message(MSG, repeats=1, rts_settle=0.08, inter_byte_delay=0.005, post_tx_wait=0.08)
